    ...
    return (
        ...
        <div className="about-sec">
            ...
            <div className="work"> 
                ...
                <h1>WHO WE ARE</h1>
                <h3>Welcome to BookEazy – your go-to destination for hassle-free online booking!</h3>
...
At BookEazy, we understand that planning to schedule an appointment for service  can sometimes be overwhelming. </p>
